...
# --- Configuration ---
GIT_REPO_URL = "https://github.com/google-deepmind/mujoco_menagerie.git"
# The path within the repository to download. This will checkout the full path.
REPO_SUB_PATH = "unitree_g1"
...
def main():
    ...
    """
    # The final destination path for the 'unitree_g1' folder
    # This will result in `static/models/unitree_g1`
    dest_path = DESTINATION_ROOT / "unitree_g1"
    ...
    with tempfile.TemporaryDirectory() as temp_dir_str:
        ...
        repo_clone_path = temp_dir / "mujoco_menagerie"
        ...
        run_command(
            ["git", "sparse-checkout", "set", REPO_SUB_PATH], cwd=repo_clone_path
        )

        # The source path of the 'unitree_g1' folder inside the cloned repo
        source_path = repo_clone_path / REPO_SUB_PATH

        # 3. Move the 'unitree_g1' folder to the final destination
